...
<div class="wrap">
		<ul class="nav">
			...
			<li><a href="blooddonated.php">Food Donated</a></li>
...
<table cellpadding="0" cellspacing="0" width="500px" class="tableborder" style="margin:auto" >
        ...
        <tr><td colspan="2" align="center"><img src="Images/donated.png" height="80px" /></td></tr>
             <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
...
<input type="text" name="year" style=" width:50px"  /></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          <tr><td class="lefttd"  style="vertical-align:middle">No Of Meals </td><td><input type="number" name="t3"  required="required" pattern="[0-9]{1,10}" title="please enter only numbers between 1 to 10 for no. of units" /></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          <tr><td class="lefttd"  style="vertical-align:middle"> food item Detail</td><td><textarea name="t4"></textarea></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
