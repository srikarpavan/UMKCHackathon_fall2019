...
<table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >
    ...
    <tr><td colspan="2"  align="center"><img src="Images/reg.png" width="300px" height="80px"  /></td></tr>
   
<tr><td colspan="2">&nbsp;</td></tr>
   
                <tr><td  style=" padding-left:20px;" ><img src="Images/food.png" width="170px" class="shaddoww"/>&nbsp; </td>
...
<tr><td class="lefttd"> location </td><td><select name="t4" required><option value="">Select</option>
<?php
$cn=makeconnection();
