...
<tr><td class="lefttd" align="center">Mobile No</td><td><input type="number" name="t3"  required="required" pattern="[0-9]{10,12}" title="please enter only numbers between 10 to 12 for mobile no." /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd" align="center">Select location </td><td><select name="t4" required><option value="">Select</option>
<?php
$cn=makeconnection();
...
<input type="text" name="year" style=" width:30px"  /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd" align="center">Address details</td><td><textarea name="t7"></textarea></td></tr>
