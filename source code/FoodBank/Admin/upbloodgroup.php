...
<tr><td colspan="2" align="center" class="toptd">Update Location</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td class="lefttd">Select Location </td><td><select name="s2" required><option value="">Select</option>
...
<tr><td class="lefttd">Location Name</td><td><input type="text"  name="t2"  value="<?php  if(isset($_POST["show"])){ echo $bg_name ;}    ?>"  required="required"  /></td></tr> </td></tr>
